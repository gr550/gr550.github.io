...
A Internet não é o mesmo que a Web. A Internet é maior, mais antiga e mais variada.
The Internet is not the same as the Web. The Internet is bigger, older, and more varied.

Imagine como as **estradas** estão _interligadas_ em todo o mundo: ruas pequenas estão ligadas a 
